...
echo "=========================================="
echo "  岱境235 State Protection Research Build"
echo "=========================================="
...
docker build -t daijin235-state-protection-research:v2.4-research \
...
echo "    - Docker镜像: daijin235-state-protection-research:v2.4-research"
echo "=========================================="