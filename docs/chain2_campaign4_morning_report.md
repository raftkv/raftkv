...
**V2.4_remote 路径**: `<ARCHIVE>/V2.4_remote`（bare git 仓库）
...
|--------|-------------------------------------|------------------------|------|------------|
| v2.4-post-batch33.bundle | ✓ | ✓ `<ARCHIVE>/bundle/` | 27.8MB | ✓ okay |
| v2.4-post-batch34.bundle | ✓ | ✓ `<ARCHIVE>/bundle/` | 27.8MB | ✓ okay |
| v2.4-post-batch35.bundle | ✓ | ✓ `<ARCHIVE>/bundle/` | 27.8MB | ✓ okay |
| v2.4-post-batch36.bundle | ✓ | ✓ `<ARCHIVE>/bundle/` | 27.8MB | ✓ okay |
...
| v2.4-post-batch20.bundle | `<ARCHIVE>/` | 散落备份 |
| v2.4-post-batch24~27.bundle | `<ARCHIVE>/` | 散落备份 |
| v2.4-post-batch23.bundle | `<ARCHIVE>/bundle/` | 已有备份 |
| v24-full-backup-20260907-v2.bundle | `<ARCHIVE>/backup/` | 全量备份 |
| batch12-full-backup-20260911.bundle | `<ARCHIVE>/` | batch12 全量 |

### 8.4 锚定结论

- **Tag 推送**: 5 个 tag（v2.4-post-batch33~36 + chain2-campaign4）已推送 V2.4_remote ✓
- **Bundle 双物理**: 4 个 CHAIN-2 bundle 均有第二物理位置 `<ARCHIVE>/bundle/` ✓
