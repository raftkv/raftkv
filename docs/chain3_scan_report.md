...
|------|----------|--------|---------------------|--------|
| A. 本地路径 | `D:\235备份文件` | 49 | ~15 | P0 |
| B. 用户路径 | `C:\Users\27998` | 11 | ~8 | P0 |
...
| 文件 | 行号 | 内容 | 处置 |
|------|------|------|------|
| docs/chain2_campaign4_morning_report.md | 137,144-163 | `D:/235备份文件/...` | → 相对路径 |
| docs/D2-FINAL-REPORT.md | 12,69,70,99,108,145 | `D:\235备份文件\...` | → 相对路径 |
| docs/kunpeng-evidence/README.md | 20 | `D:\235备份文件\archive-...` | → 删除行 |
| docs/kunpeng-evidence/00_总索引...md | 264 | `D:\235备份文件\...` | → 删除行 |
| tests/deploy/run_baseline33.bat | 2-5 | `D:\235备份文件\...` | → `%~dp0` 相对路径 |
| cmd/gen_lic_tmp/main.go | 26 | `D:\235备份文件\岱境235_RSA密钥备份\...` | → env var |
| cmd/license-tool/main.go | 18 | `D:\235备份文件\岱境235_RSA密钥备份\...` | → env var |
| 双模式授权配置说明.md | 283,302 | `D:\235备份文件\...` | → 相对路径 |
| _state_protection_research/*.md | 多行 | `D:\235备份文件\...` | → 相对路径 |
| tests/auto/*/REPORT.md | 多行 | `D:\235备份文件\...` | → 删除或脱敏 |
| tests/evidence/*/...md | 多行 | `D:\235备份文件\...` | gitignored，标注 |

### 2.2 用户路径 (C:\Users\27998)

| 文件 | 行号 | 内容 | 处置 |
|------|------|------|------|
| tests/deploy/deploy.env | 5 | `LICENSE_DIR=C:/Users/27998/.daijin235/...` | → env var |
| tests/deploy/deploy_batch12.env | 5 | 同上 | → env var |
| docs/D3-AUDIT-REPLY.md | 60 | 同上 | → env var |
| docs/D3-SEC-ROTATE-EVIDENCE.md | 72 | `C:\Users\27998\.sm4_key_old` | → 占位符 |
| cmd/gen_lic_tmp/main.go | 27 | `C:\Users\27998\.daijin235\...` | → env var |
| docs/kunpeng-evidence/07_.../TCX-Ⅱ...md | 240,247 | `C:\Users\27998\...` | → 删除行 |
| _state_protection_research/tasks.md | 298 | `C:\Users\27998\Desktop\...` | → 相对路径 |
| _state_protection_research/spec.md | 532 | `C:\Users\27998\Desktop\` | → 相对路径 |
| start_monitor.bat | 2 | `C:\Users\27998\Desktop\...` | → env var |
| README_DOCKER.md | 15 | `C:\Users\27998\Desktop\...` | → 相对路径 |
...
| cmd/gen_lic_tmp/main.go | 26 | `D:\235备份文件\岱境235_RSA密钥备份\...` | P0 | → env var `RSA_PRIVATE_KEY_PATH` |
...
- `D:\235备份文件\...` → 相对路径或 env var
- `C:\Users\27998\...` → env var 或占位符
