...
| DEBT-0003 | batch20 | batch21 | 待清 | decomp_c512_raw.json 四构成项补全：需将 batch18 埋点实测数据整理为 quorum_wait/fsync_wait/RPC/排队 四构成项 × {P50, P99, P50_ratio, P99_ratio} 全字段，KB 级完整数据 | — |
