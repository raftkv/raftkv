...
$testDir = "D:\235备份文件\V2.4_Performance_Sandbox\tests\evidence\d3-batch2-p1\E08-rerun5"
...
$startTime = Get-Date
Write-Output "E08-rerun5 START: $($startTime.ToString('yyyy-MM-dd HH:mm:ss'))"
...
Write-Output "E08-rerun5 END: $($endTime.ToString('yyyy-MM-dd HH:mm:ss'))"
